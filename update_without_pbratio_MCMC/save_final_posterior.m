...
'St Dev LTVH','$\epsilon_{LTVH}$';...
'St Dev EbF','$\epsilon_{EbF}$';...
%'\sigma_e','$\sigma_e$';...
%'sigma_m','$\sigma_m$';...
%'sigma_B','$\sigma_B$';...
'\psi_i','$\psi_i$';...
...
load('C:\Users\tolga\OneDrive\Desktop\3d_model_update_feb8_2020\update_without_pbratio_MCMC\LTV1\metropolis\LTV1_mh1_blck1.mat');

logpost_final(1:N)=logpo2(1:end);
posteriorDist(1:N,:)=x2(1:end,:);
...
subplot(3,5,index);hist(plot_var);
%hold on;
...
figure('Name','Posterior Distributions Calvo','units','normalized','outerposition',[0 0 0.6 0.3]);
subplot(1,3,1);
