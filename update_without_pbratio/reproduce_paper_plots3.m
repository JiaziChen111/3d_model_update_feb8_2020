...
%===============================================================================================================
 Cyphi_H=0;Cyphi_F=0;phi_Hs=0.11;phi_Fs=0.15;phis=0.11;epsilonH1s=0.86;epsilonF1s=0.86;LTVHrule=0;LTVFrule=0;
...
% Cyphi_H=0.4;Cyphi_F=0.4;phi_Hs=0.11;phi_Fs=0.11;phis=0.11;epsilonH1s=0.86;epsilonF1s=0.86;LTVHrule=0;LTVFrule=0;
 Cyphi_H=0;Cyphi_F=0;phi_Hs=0.11;0;phi_Fs=0.15;0;phis=0;epsilonH1s=0.86;epsilonF1s=0.86;LTVHrule=0;LTVFrule=0;
zeta_m=0.15; 
zeta_F=0.15;
%===============================================================================================================
set_parameter_values_counterfactual( Cyphi_H,Cyphi_F,phi_Hs,phi_Fs,phis,epsilonH1s,epsilonF1s,LTVHrule,LTVFrule,zeta_m,zeta_F)
        ...
        hold on;
          ...
          plot(irf4(:,vv,ss),'color','blue');
           ...
           title(var_names_plot(ss));
                   ...
                   if ss==1
%                   legend('Estimated Stickiness, No Housing CCyB',...
%         'Estimated Stickiness, with 2.5 % Housing CCyB',...
%         'Low Stickiness, No Housing CcyB',...
%         'Low Stickiness, with 2.5 % Housing CCyB');              
                       
                       
%            leg= legend('Estimated Stickiness, No Corporate CCyB',...
%         'Estimated Stickiness, with 2.5 % Corporate CCyB',...
%         'Low Stickiness, No Corporate CcyB',...
%         'Low Stickiness, with 2.5 % Corporate CCyB');

%           leg=  legend('Estimated Stickiness, LTV=0.86',...
%         'Estimated Stickiness, LTV=0.8',...
%         'Low Stickiness, LTV=0.86',...
%         'Low Stickiness, LTV=0.8');
% 
%           leg=  legend('Estimated Stickiness, CAR=11%',...
%         'Estimated Stickiness, CAR=15%',...
%         'Low Stickiness, CAR=11%',...
%         'Low Stickiness, CAR=15%');
% % 
%          leg=   legend('Estimated Stickiness, Housing SCR=11%',...
%         'Estimated Stickiness, Housing SCR=15%',...
%         'Low Stickiness,Housing SCR=11%',...
%         'Low Stickiness, Housing SCR=15%');
% %     
         leg=    legend('Estimated Stickiness, Corporate SCR=11%',...
        'Estimated Stickiness, Corporate SCR=15%',...
        'Low Stickiness,Corporate SCR=11%',...
        'Low Stickiness, Corporate SCR=15%');   
%     
...
% print(fig,['stickiness_corporate_CCyB' char(shock_names(vv))],'-dpdf');
% print(fig,['stickiness_housing_CCyB' char(shock_names(vv))],'-dpdf');
%  print(fig,['stickiness_corporate_SCR' char(shock_names(vv))],'-dpdf');
print(fig,['stickiness_housing_SCR' char(shock_names(vv))],'-dpdf');
end
