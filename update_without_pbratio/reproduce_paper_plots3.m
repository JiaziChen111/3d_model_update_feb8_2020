...
%===============================================================================================================
 Cyphi_H=0.051;Cyphi_F=0.128;phi_Hs=0.11;phi_Fs=0.11;phis=0.11;epsilonH1s=0.86;epsilonF1s=0.86;LTVHrule=0;LTVFrule=0;
...
% Cyphi_H=0.4;Cyphi_F=0.4;phi_Hs=0.11;phi_Fs=0.11;phis=0.11;epsilonH1s=0.86;epsilonF1s=0.86;LTVHrule=0;LTVFrule=0;
 Cyphi_H=0.051;Cyphi_F=0.128;phi_Hs=0.11;0;phi_Fs=0.11;0;phis=0;epsilonH1s=0.86;epsilonF1s=0.86;LTVHrule=0;LTVFrule=0;
zeta_m=0.15; 
zeta_F=0.15;
%===============================================================================================================
set_parameter_values_counterfactual( Cyphi_H,Cyphi_F,phi_Hs,phi_Fs,phis,epsilonH1s,epsilonF1s,LTVHrule,LTVFrule,zeta_m,zeta_F)
...
print(fig,['stickiness_CCyB' char(shock_names(vv))],'-dpdf');
end
