...
rho_phiH sigma_phiH rho_phiF sigma_phiF rho_epsH sigma_epsH 
;
    
varexo epsiA  epsiJ epsiK epsiSe epsiSm epsiSB epsiWb  epsiWe epsiH epsiHd epsiHk epsimarkup_m epsimarkup_F epsiEC epsiECAB epsiEL epsiEbH epsiEbF epsiLTVH epsiLTVF epsi_phiH epsi_phiF epsi_epsH;
...
(EphiH)=rho_phiH*(EphiH(-1))+epsi_phiH;
(EphiF)=rho_phiF*(EphiF(-1))+epsi_phiF;
(EepsH)=rho_epsH*(EepsH(-1))+epsi_epsH;
...
//zeta_m,  0.746  ,0,1,BETA_PDF,0.5,0.2;//standard prior for stickiness terms-->check whether another paper attempts to estimate this
//zeta_F,0.5633,0,1,BETA_PDF,0.5,0.2;//standard prior for stickiness terms-->check whether another paper attempts to estimate this
