function []=set_parameter_values_policy( set_Cyphi_H,set_Cyphi_F,set_phi_Hs,set_phi_Fs,set_phis,set_epsilonH1s,set_epsilonF1s,set_LTVHrule,set_LTVFrule,set_zeta_m,set_zeta_F)
set_sigma_epsiHd=   0 ;  %  shock to housing depreciation cost in EdH and EdK %1
set_sigma_epsiHk= 0 ; % shock to capital depreciation 
...
set_sigma_epsiSm=  0 ; % housing risk shock in ESm %8fd
 set_sigma_epsiWe=0 ;%  [0.00423589602188688]    ; %  entrepreneur net worth shock in EWe %13
...
set_rhoSH =  set_rhoSF ;  %53
 set_rhoWb =0; %54
set_rhoWe =  0;% [0.139485190273843] ;  %55
set_rhoHd =0 ; %56
set_rhoHk = 0 ; %57
...
set_nu=0.5; %SS*** penalty cost parameter,  appears in A1, C1 %67
 ...
 %interest stickiness
% set_zeta_m=0.7179; %SS***  Interest rate stickiness, same as below, appears in  R_m R_F %59
% set_zeta_F=0.4967 ; %SS*** Interest rate stickiness,  appears in 51 FOC for bank business lending, 51 is not in use  %60
 %prudential parameters: 
 %capital requirements


%HISTORICAL MEAN PARAMETERS FOR MEASUREMENT EQUATIONS
set_gamma_y=0.476844824685443;%steady_state(introduced as a free parameter) level of output growth
set_gamma_w= 0.718502239050121;
set_gamma_inve=0.337298218737961;
set_gamma_c=0.543176818442490;
