...
Cyphi_H=0;
Cyphi_F=0;
phi_Hs=0.11;%0.158;%0.2112;
phi_Fs=0.11;%0.05;%0.125%;%0.05;
epsilonH1s=0.86;%0.89;%0.94%;%0.89%
epsilonF1s=0.86;
LTVHrule=0;
LTVFrule=0;
phis=0.11;
...
%total=0;duration=20;
ex_BASELINE(init_period:init_period+duration-1,22)=(total/duration)*ones(duration,1);
total=0.0808;duration=20;
%total=0;duration=20;
ex_BASELINE(init_period:init_period+duration-1,23)=(total/duration)*ones(duration,1);
